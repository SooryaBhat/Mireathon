...
function Theme3DCard({
  ...
  const handleMouseMove = (e: React.MouseEvent<HTMLDivElement>) => {
    ...
    // Subtle 3D tilt calculation (-10 deg to 10 deg)
  ...
  return (
    ...
    >
      <div
        ...
        className={`group relative rounded-2xl p-6 glass-rift cursor-pointer border border-purple-500/30 ${track.borderGlow} flex flex-col justify-between overflow-hidden transform-gpu select-none min-h-[420px]`}
      >
        {/* Top Accent Bar */}
        <div
        ...
        <div>
          ...
          <div className="relative w-full h-56 rounded-xl overflow-hidden mb-6 bg-black/80 border border-white/10 group-hover:border-cyan-400/50 transition-colors">
            <Image
              src={track.image}
              alt={track.name}
              fill
            ...
            {/* Track Number Badge */}
            <div className="absolute top-3 left-3 px-3 py-1 rounded-md bg-black/80 border border-white/20 font-mono text-[10px] uppercase tracking-widest text-cyan-300 backdrop-blur-md">
              TRACK {track.num}
            </div>
          ...
          {/* Track Title */}
          <h3
            className="text-2xl font-bold font-mono uppercase tracking-wide group-hover:text-white transition-colors"
            style={{ color: track.accentColor }}
          >
            {track.name}
          </h3>
          <p className="text-xs font-mono text-cyan-400/90 mt-1 uppercase tracking-wider">
            {track.subtitle}
          </p>

          <p className="text-gray-300 font-sans text-xs sm:text-sm mt-3 line-clamp-3 leading-relaxed">
            {track.description}
          </p>
        </div>

        {/* Card Footer CTA */}
        <div className="mt-6 pt-4 border-t border-white/10 flex items-center justify-between font-mono text-xs text-gray-400 group-hover:text-white transition-colors">
...
export default function ThemesGrid() {
  ...
  return (
    <section id="themes" className="relative py-28 px-6 bg-[#05050a] text-white overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          <motion.div
            ...
            whileInView={{ opacity: 1, y: 0 }}
            viewport={{ once: true }}
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-purple-950/60 border border-purple-500/40 text-purple-300 font-mono text-xs tracking-widest uppercase mb-4 shadow-[0_0_15px_rgba(138,43,226,0.3)]"
          >
          ...
          <motion.p
            ...
            className="mt-4 max-w-xl mx-auto text-gray-400 font-sans text-sm sm:text-base"
          >
        ...
        {selectedTrack && (
          ...
          >
            ...
            <motion.div
              ...
              className="relative w-full max-w-3xl max-h-[90vh] overflow-y-auto rounded-3xl glass-rift border border-cyan-400/50 shadow-[0_0_60px_rgba(34,211,238,0.35)] text-white z-10"
            >
              ...
              <div className="relative w-full h-64 sm:h-80 overflow-hidden rounded-t-3xl">
                ...
                <button
                  ...
                  className="absolute top-5 right-5 p-2.5 rounded-full bg-black/70 border border-white/30 text-gray-300 hover:text-white hover:border-cyan-400 transition-all z-20 backdrop-blur-md shadow-[0_0_15px_rgba(0,0,0,0.8)]"
                >
                  <X className="w-5 h-5" />
                </button>
                ...
                <div className="absolute bottom-6 left-6 right-6 flex flex-col justify-end">
                  ...
                  <h3 className="text-3xl sm:text-4xl font-extrabold font-mono uppercase text-white drop-shadow-[0_0_20px_rgba(0,0,0,0.9)]">
                    {selectedTrack.name}
                  </h3>
                  <p className="text-sm font-mono text-cyan-300/90 uppercase tracking-wider mt-1">
              ...
              {/* Detail Content Body */}
              <div className="p-6 sm:p-8 space-y-6 font-sans text-sm sm:text-base text-gray-200">
                <p className="leading-relaxed text-gray-300">{selectedTrack.description}</p>

                {/* Core Problem Statement Box */}
                <div className="p-5 rounded-2xl bg-purple-950/40 border border-purple-500/40 space-y-2 backdrop-blur-sm">
                  ...
                  <p className="text-sm font-mono text-gray-100 leading-relaxed">{selectedTrack.problemStatement}</p>
                </div>
                ...
                <div className="mt-8 pt-4 border-t border-white/10 flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="px-6 py-3 rounded-xl font-mono text-xs font-bold uppercase tracking-wider bg-gradient-to-r from-purple-600 via-cyan-500 to-pink-600 text-white hover:opacity-90 transition-opacity shadow-[0_0_25px_rgba(138,43,226,0.6)]"
                  >
